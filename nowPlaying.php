...
searchIcon.addEventListener("click", ()=>{
    ...
    function fetchPopularPageResults() {
        fetch('https://api.themoviedb.org/3/movie/now_playing?api_key=96722bcb778d0302594f6c5268f3a8fc')
        .then(res => res.json())
        .then(data => {
            for(let i = 0; i>=0; i++)
            {
...
fetchPopularPageResults();
    ...
    function fetchPopularPageResults2() {
        fetch('https://api.themoviedb.org/3/movie/now_playing?api_key=96722bcb778d0302594f6c5268f3a8fc&page=2')
        .then(res => res.json())
        .then(data => {
            for(let i = 0; i>=0; i++)
            {
