...
<head>
    ...
    <title>Popular TV and Web Series</title>
...
searchIcon.addEventListener("click", ()=>{
    ...
    function fetchPopularPageResults() {
        fetch('https://api.themoviedb.org/3/discover/tv?api_key=96722bcb778d0302594f6c5268f3a8fc&first_air_date.gte=2023&with_origin_country=US')
        .then(res => res.json())
        .then(data => {
            for(let i = 0; i>=0; i++)
            {
